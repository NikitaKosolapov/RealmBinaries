...
curl -L -O "https://github.com/realm/realm-swift/releases/download/v$REALM_VERSION/RealmSwift@$XCODE_VERSION.spm.zip"

REALM_SWIFT_CHECKSUM=$(swift package compute-checksum RealmSwift@$XCODE_VERSION.spm.zip)
